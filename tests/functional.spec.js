...
const CALCS = {
  ...
  water: {
    ...
    autosaveDataKey: 'fieldHospitalWaterAutosave',
    autosaveTimestampKey: 'fieldHospitalWaterLastSaved',
  ...
  consumables: {
    ...
    autosaveDataKey: 'cons-fieldHospitalDays',
    autosaveTimestampKey: 'cons-lastSaved',
    outputSel: null,
  ...
  medicines: {
    ...
    autosaveDataKey: 'fieldHospitalPharmaDays',
    autosaveTimestampKey: 'fieldHospitalPharmaLastSaved',
    outputSel: null,
