...
$mdPath = Join-Path $PSScriptRoot "Load-Calc-Basic-Quickstart.md"
$pdfPath = Join-Path $PSScriptRoot "Load-Calc-Basic-Quickstart.pdf"
...
foreach ($line in $rawLines) {
  ...
  # Keep it simple and readable for field users.
